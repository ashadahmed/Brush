...
public class BidPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        digital = Integer.toString(R.id.bid_category1);
        traditional = Integer.toString(R.id.bid_category2);
        photography= Integer.toString(R.id.bid_category3);
        craft = Integer.toString(R.id.bid_category4);
